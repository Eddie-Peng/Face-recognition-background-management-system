$(document).ready(function(){
	...
	/*------- Just Gage Init -------*/
	g1=new JustGage({id:"g1",value:35,min:0,max:100,title:"楼栋当前访客量",label:"每小时"});
	g1a=new JustGage({id:"g1a",value:12,min:0,max:100,title:"未在登记名单访客",label:"每小时"});
	g2=new JustGage({id:"g2",value:15,min:0,max:100,title:"1-2楼访客",label:""});
	g2a=new JustGage({id:"g2a",value:7,min:0,max:100,title:"3-4楼访客",label:""});
	g2b=new JustGage({id:"g2b",value:22,min:0,max:100,title:"5-6楼访客",label:""});
	
	setInterval(function(){
		g1.refresh(getRandomInt(46,49));
		g1a.refresh(getRandomInt(24,29));
		g2.refresh(getRandomInt(19,23));
		g2a.refresh(getRandomInt(24,27));
		g2b.refresh(getRandomInt(16,19))
		},5000
	);

	...
	<div id="output">
		<div class="containerT">
			...
			<form class="form" id="entry_form" action="InsertServletManager">
				<input type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'') " onafterpaste="this.value=this.value.replace(/[^\d]/g,'') " placeholder="请输入您新注册的管理员id" id="manager_id" name="manager_id" >

            ...
            <div class="ibox float-e-margins">
                ...
                <div>
                    <div class="ibox-content no-padding border-left-right">
                        <img alt="image" class="img-responsive" src="img/monkey_king.jpg">
                    </div>
                        ...
                        <div class="feed-activity-list">
                            ...
                            <div class="feed-element">
                                <a href="per_space_profile.jsp" class="pull-left">
                                    <img alt="image" class="img-circle" src="img/tang.png">
                                </a>
                            ...
                            <div class="feed-element">
                                <a href="per_space_profile.jsp" class="pull-left">
                                    <img alt="image" class="img-circle" src="img/sha.jpg">
                                </a>
                                <div class="media-body ">
                            ...
                            <div class="feed-element">
                                <a href="per_space_profile.jsp" class="pull-left">
                                    <img alt="image" class="img-circle" src="img/pig.png">
                                </a>
                                <div class="media-body ">
                            ...
                            <div class="feed-element">
                                <a href="per_space_profile.jsp" class="pull-left">
                                    <img alt="image" class="img-circle" src="img/bbeb.jpg">
                                </a>
                                <div class="media-body ">
                                    ...
                                    <div class="photos">
                                        <a target="_blank" href="#">
                                            <img alt="image" class="feed-photo" src="img/longgon1.jpg">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="feed-element">
                                <a href="per_space_profile.jsp" class="pull-left">
                                    <img alt="image" class="img-circle" src="img/bberb.jpg">
                                </a>
                                <div class="media-body ">

        ...
        <div class="containerT">
            ...
            <form class="form" id="entry_form" action="LoginServletManager">
                <input type="text" onkeyup="this.value=this.value.replace(/[^\d]/g,'') "
                       onafterpaste="this.value=this.value.replace(/[^\d]/g,'') " placeholder="管理员id" id="manager_id"
                       name="manager_id">
                ...
                <br>
                <a text-align="center" href="registration.jsp" style="text-decoration: none;color: #000000;">没有账号？</a>
